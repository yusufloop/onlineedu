<?php
    ...
    */
    $sql ="SELECT * FROM PersonalInfo INNER JOIN Dashboard ON PersonalInfo.MatricNo =Dashboard.MatricNo";
                            ...
                            <article class="blog_item">
                                ...
                                <div class="blog_details">
                                    <a class="d-inline-block" href="blog_details.html">
                                        <h2 class="blog-head" style="color: #2d2d2d;"><?php echo $row["Details"];?></h2>
                                    </a>
                                    <ul class="blog-info-link">
                                        <li><a href="#"><i class="fa fa-user"></i> <?php echo $row["Anjuran"];?></a></li>
                                    </ul>
                                </div>
                            </article>
                            <article class="blog_item">
