<?php
    ...
    */
    $sql ="SELECT * FROM PersonalInfo INNER JOIN Financial INNER JOIN Guardiance ON PersonalInfo.MatricNo =Financial.MatricNo = Guardiance.MatricNo";
...
<td><?php echo $row["DateBanking"];?></td>
      ...
      <div class="table-responsive">
        <table class="table ">
          <thead>
            ...
            <tr>
              <td><b>Guardian Number Phone</b></td>
              <td><?php echo $row["NumPhone"];?></td>
              <td><b>Address</b></td>
              <td> <?php echo $row["Address"];?></td>
            </tr>
