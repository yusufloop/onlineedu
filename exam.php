<?php
    ...
    */
    $sql ="SELECT * FROM ExamMark INNER JOIN ExamSchedule ON ExamMark.MatricNo = ExamSchedule.MatricNo";
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="about-details-cap mb-50">
                            ...
                            <h2><u>Course Performance Detail</u></h2>
							
							<h5>Session/semester  </5>
							<h5>Semester 2</h5>
...
<td><?php echo $row["WarningLetter"];?></td>
<td><?php echo $row["CourseWorkMark"];?></td>
