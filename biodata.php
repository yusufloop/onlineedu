<?php
    ...
    */
    $sql ="SELECT * FROM PersonalInfo INNER JOIN ParentInfo ON PersonalInfo.MatricNo =ParentInfo.MatricNo ";
    ...
    <main>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8">
						...
						<div align="center"><img src="E:\file coding\FYP2020\onlineedu\assets\img\Graduation\logoKtd.png" alt="logoKtd.png" width="400px" >
						</div>
      ...
      <div class="table-responsive">
        <table class="table ">
          <thead>
            <tr>
              <th><b>Name Guardian</b></th>
              <th> <?php echo $row["GuardianName"];?></th>
              <th></th>
              <th></th>
            </tr>
          </thead>
            ...
            <tr>
              <td><b>Ic Number Guardian</b></b></td>
              <td><?php echo $row["IcNoGuardian"];?></td>
              <td></td>
              <td></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td><b>Number Phone Guardian</b></td>
              <td><?php echo $row["NumPhone"];?></td>
            </tr>
            <tr>
              <td><b>Office Number</b></td>
              <td> <?php echo $row["OfficeNum"];?></td>
              <td><b>Email</b></td>
              <td> <?php echo $row["Email"];?></td>
            </tr>
