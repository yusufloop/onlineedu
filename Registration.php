<?php
    ...
    */
    $sql ="SELECT * FROM PersonalInfo INNER JOIN CourseRegisteration ON PersonalInfo.MatricNo = CourseRegisteration.MatricNo";
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="about-details-cap mb-50">
                            <h2>Registration info >> Record of Course Registration</h2>
 <!--table course list--> 
...
<div class="divBox comicGreen">
<div class="divBoxBody">
<div class="divBoxRow">
<div class="divBoxCell">Minimum Credits<p style="font-size:250%;color:white;" ><?php echo $row["MinCourse"];?></p> </div>
<div class="divBoxCell">Maximum Credit<p style="font-size:250%;color:white;" ><?php echo $row["MaxCourse"];?></p> </div>
<div class="divBoxCell">Credit Registered<p style="font-size:250%;color:white;" ><?php echo $row["CreditHour"];?></p> </div></div>
</div>
</div>'

<!-- button click-->
<a href="#" class="myButton">Register here</a>
